  ...
  <div class="grid grid-cols-5">
    ...
    <div :class="{ 'gap-1 mt-1': mobile }"
      ...
      <div class="grid grid-cols-5 items-center">
        ...
        <div class="col-span-4">
          <TextField label="Email" inputType="email" v-model="data.user.email" :inputValue="data.user.email"/>
        </div>
      </div>
      <!-- contract time -->
      <div class=" grid grid-cols-5 items-center">
        ...
        <div class="col-span-4">
          <TextField label="ContractTime" inputType="contractTime" v-model="data.user.contractTime" :inputValue="data.user.contractTime"/>
        </div>
      </div>
      <!-- role -->
      <div class="grid grid-cols-5 items-center">
      ...
      <div class="grid grid-cols-5 items-center">
        ...
        <div class="col-span-4">
          <TextField label="Password" inputType="password" v-model="data.user.password" :inputValue="data.user.password"/>
        </div>
      </div>
      <div class="grid grid-cols-5 items-center">
        <v-icon>mdi-lock-check-outline</v-icon>
        <div class="col-span-4">
          <TextField label="Confirm Password" inputType="password" v-model="data.user.password" :inputValue="data.user.password"/>
        </div>
      </div>
    </div>
